                                        ...
                                        <div className="share">
                                            <div className="tags flex gap-2 items-center">
                                                ...
                                                <div className="flex flex-wrap gap-2 px-4 flex-auto py-6">
                                                    ...
                                                    <Link rel="noopener noreferrer" href={"whatsapp://send?text=https://vizackenterprises.com/blogs/blog2/"} data-action="share/whatsapp/share" target="_blank" className="hover:text-[#ff6900] transition-colors duration-300" >Whatsapp</Link>
