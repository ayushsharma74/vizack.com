...
export default function Compiler() {
    ...
    // preloaded Content
    const cmd = `/*    Commands   */
banner(bannerImage Address)
publisher.image(Publisher Image Address)
publisher.name(Publisher Name)
publisher.about(Write something about Author)
publisher.facebook(Facebook link of Publisher)
publisher.linkedin(LinkedIn link of Publisher)
publisher.twitter(Twitter link of Publisher)
publisher.instagram(Instagram link of Publisher)
publisher.date(Published Date)
title(Blog Title)
par(Paragraph)
note(Note, Note By)
...
tags(Tag1, Tag2, Tag3,...,TagN)
    ...
    function preview() {
        ...
        async function saveData() {
            const urls = 'http://www.vizackenterprises.com/api/saveData';
            await axios({
                method: 'post',
                url: urls,
                headers: {
        ...
        async function saveData() {
            ...
            await axios({
                ...
                async function handleSubmit() {
                    let url = `http://www.vizackenterprises.com/blogs/src/app/employee/blogs/blog/${build.name.replaceAll(" ", "").toLowerCase()}`
