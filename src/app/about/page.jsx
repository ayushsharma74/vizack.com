      ...
      <div>
        <div className="bg-white py-6 sm:py-8 lg:py-12">
          <div className="mx-auto max-w-screen-md px-4 md:px-8">
            <h1 data-aos="fade-up" data-aos-delay="50" data-aos-duration="1000" className="mb-4 text-center text-2xl font-bolder text-default sm:text-3xl md:mb-6 max-sm:mt-16 ">About Us</h1>
