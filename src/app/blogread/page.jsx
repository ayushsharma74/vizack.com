                                        ...
                                        <div className="share">
                                            <div className="tags flex gap-2 items-center">
                                                ...
                                                <div className="flex flex-wrap gap-2 px-4 flex-auto py-6">
                                                    <Link rel="noopener noreferrer" href={"https://www.facebook.com/sharer/sharer.php?u=http://localhost:3000/blogread"} target="_blank" className="hover:text-[#ff6900] transition-colors duration-300" >Facebook</Link>
                                                    <Link rel="noopener noreferrer" href={"https://twitter.com/intent/tweet?url=http://localhost:3000/blogread&text=Check%20out%20my%20blog%20post"} target="_blank" className="hover:text-[#ff6900] transition-colors duration-300" >X</Link>
                                                    <Link rel="noopener noreferrer" href={"https://www.linkedin.com/shareArticle?url=Yhttp://localhost:3000/blogread&title=How can I grow my stocks"} target="_blank" className="hover:text-[#ff6900] transition-colors duration-300" >Linkedin</Link>
                                                    <Link rel="noopener noreferrer" href={"whatsapp://send?text=http://localhost:3000/blogread"} data-action="share/whatsapp/share" target="_blank" className="hover:text-[#ff6900] transition-colors duration-300" >Whatsapp</Link>
                                                </div>
                                    ...
                                    <div className="about-publisher flex max-lg:flex-wrap items-center gap-4 px-6 py-8 rounded-2xl bg-[#F2F7FF]">
                                        ...
                                        <div className="about flex flex-col gap-2">
                                            ...
                                            <div className="social flex gap-4">
                                                <Link href={"https://"}><i className="text-[#005EF9] hover:text-default text-xl transition-colors duration-300 icofont-facebook"></i></Link>
                                                <Link href={"https://"}><i className="text-[#005EF9] hover:text-default text-xl transition-colors duration-300 icofont-twitter"></i></Link>
                                                <Link href={"https://"}><i className="text-[#005EF9] hover:text-default text-xl transition-colors duration-300 icofont-linkedin"></i></Link>
                                                <Link href={"https://"}><i className="text-[#005EF9] hover:text-default text-xl transition-colors duration-300 icofont-instagram"></i></Link>
                                            </div>
                                        </div>
                                    </div>
