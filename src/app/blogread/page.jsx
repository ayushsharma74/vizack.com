                                        ...
                                        <div className="share">
                                            <div className="tags flex gap-2 items-center">
                                                ...
                                                <div className="flex flex-wrap gap-2 px-4 flex-auto py-6">
                                                    ...
                                                    <Link rel="noopener noreferrer" href={"https://www.linkedin.com/shareArticle?url=https://vizackcom.vercel.app/blogread&title=How can I grow my stocks"} target="_blank" className="hover:text-[#ff6900] transition-colors duration-300" >Linkedin</Link>
