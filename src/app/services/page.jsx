    ...
    <>
      ...
      <div>
        <Content 
          ...
          content={`Transform your online presence into a digital masterpiece with our website design and development services. From concept to creation, we craft visually stunning, user-friendly websites that captivate audiences and drive results.`} 
          extraContent={' Elevate your brand with a website that not only looks great but also delivers an exceptional user experience.'} 
        />
        <Content 
          image_src={"/assets/testing/7038058.jpg"} 
          service={"Public Relations"} 
          content={`Ignite conversations, shape perceptions, and build lasting relationships with our strategic public relations solutions. From media relations to reputation management, we amplify your brand's voice, ensuring it resonates with the right audiences at the right time. Navigate the ever-changing media landscape with confidence, guided by our seasoned PR experts.`} 
          extraContent={' Empower your brand with strategic public relations solutions tailored to your unique needs.'} 
        />
        <Content 
          image_src={"/assets/testing/2598560c.jpg"} 
          service={"Data Analytics"} 
          content={` Unlock the power of data with our comprehensive analytics services. From data collection to actionable insights, we help you harness the full potential of your data assets. Dive deep into the numbers, uncovering hidden patterns and trends that drive informed decision-making and fuel business growth. Turn data into your competitive advantage with our advanced analytics solutions.`} 
          extraContent={' Gain actionable insights and unlock the full potential of your data with our advanced analytics solutions.'} 
        />
        <Content 
          image_src={"/assets/testing/7039196.jpg"} 
          service={"Strategic Sales"} 
          content={`Revolutionize your sales approach with our strategic sales solutions. From lead generation to conversion optimization, we craft tailored strategies that drive results. Break through barriers, unlock new markets, and accelerate your sales pipeline with our innovative approaches and proven methodologies. Elevate your sales game and achieve sustainable growth with our strategic guidance.`} 
        ...
        <Content 
          ...
          content={`Empowering political leaders, candidates, and organizations with strategic guidance and innovative solutions is our mission. Our experienced team crafts compelling narratives and winning campaign strategies tailored to your specific goals. With a focus on integrity and transparency, we partner with those committed to positive change, shaping the future of politics together.`} 
          extraContent={' Shape the future of politics and achieve your goals with our strategic political consulting services.'} 
        />
      </div>
    </>
  );
