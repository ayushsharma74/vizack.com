          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="div">
              <ul className="flex flex-col px-4 leading-9">
                ...
                <li><Link target="_blank" rel="noopener noreferrer" className="text-default-gray hover:text-white text-md" href={"https://forms.gle/au6P4oBjpR6Zswq17"}>Intern With Us</Link></li>
                <li><Link target="_blank" rel="noopener noreferrer" className="text-default-gray hover:text-white text-md" href={"https://forms.gle/rvW3tUsGgnY56HTY8"}>Career Options</Link></li>
                <li><Link target="_blank" rel="noopener noreferrer" className="text-default-gray hover:text-white text-md" href={"http://wa.me/+919826258659"}>Customer Support</Link></li>
              </ul> 
            </div>
          </div>
