          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="div">
              <ul className="flex flex-col px-4 leading-9">
                ...
                <li><Link className="text-default-gray hover:text-white text-md" href={"https://forms.gle/au6P4oBjpR6Zswq17"} target="_blank">Intern With Us</Link></li>
                <li><Link className="text-default-gray hover:text-white text-md" href={"https://forms.gle/rvW3tUsGgnY56HTY8"} target="_blank">Career Options</Link></li>
