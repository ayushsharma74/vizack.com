...
const Newsletter = () => {
  return (
    <div className="relative flex min-h-10 flex-col items-center justify-center overflow-hidden bg-white p-8 sm:p-12">
      <div className="w-full max-w-4xl rounded-md border-2 border-gray-100 bg-default p-14 shadow-2xl">
        <div className="flex flex-col items-center">
          ...
          <h3 className="mt-2 max-w-2xl text-center text-2xl font-bold leading-tight sm:text-3xl md:text-4xl md:leading-tight">Subscribe to our Official Newsletter.</h3>
